...
func SetMotorDirection(dir MotorDirection) {
	MotorDirectionToInt := make(map[MotorDirection]int)
	MotorDirectionToInt["up"] = 1
	MotorDirectionToInt["down"] = -1
	MotorDirectionToInt["stop"] = 0
	_mtx.Lock()
	defer _mtx.Unlock()
	_conn.Write([]byte{1, byte(MotorDirectionToInt[dir]), 0, 0})
}
...
//Only writes to receiver if value is true
